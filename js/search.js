const sections = [
    ...
    { name: 'Payment Gateways', link:'../html/payment-gateways.html', description:'Premier Payment Charge is our sister company and offers a powerful online gateway to help your business process transactions quickly, safely, and securely.'},
    ...
    { name: 'Testimonials', link: '../html/testimonials.html', description:'At Premier Payments, we take the time to get to know each customer and custom tailor our products to their needs. Here’s what our customers have to say about Premier' },
